...
namespace TTGenerator.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void FetchData()
        {
            ...
            var clg = mvcDemoDbContext.clg_tt_level.FromSqlRaw($"select * from clg_tt_level").ToList();
        ...
        public void FetchData1()
        {
            ...
            var clg = mvcDemoDbContext.clg_tt_level.FromSqlRaw($" select * from [clg_tt_level] where semester_id = 6 and year_s = 'III' and batch_start_year = 2020;").ToList();
            int i = 0;
            int c = clg.Count;
            Console.WriteLine("c-count");
            Console.WriteLine(c);
        ...
        public async Task<IActionResult> Login(Login loginrequest)
        {
            ...
            if (login != null)
            {
                ...
                if ((login.password_l == loginrequest.password_l) && (login.roleid == 105))
                {
                    string fileName = @"C:\Users\vishn\OneDrive\Desktop\finalcode.py";
